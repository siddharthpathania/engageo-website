...
const PRICING_DESCRIPTION =
  'Transparent INR pricing for Indian clinics. Solo (1 clinic) from ₹7,499/month or ₹81,999/year, Growth (up to 3 clinics) from ₹22,497/month or ₹2,45,997/year, Enterprise custom. Pay monthly, quarterly, or yearly — free CRM, ₹7/minute after your included calls, 14-day free trial.';
      ...
      <SectionWrapper id="pricing-hero" className="pt-10 md:pt-14">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-[16px] leading-relaxed text-subtle md:text-lg">
            ...
            a hospital chain. Pay monthly, quarterly, or yearly — longer terms
            cost less per month. A free CRM and a 14-day free trial on every
            plan, no credit card, no contracts.
          </p>
        </div>
      </SectionWrapper>
