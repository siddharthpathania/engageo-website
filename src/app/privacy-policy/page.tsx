    ...
    >
      ...
      */}
      <LegalSection id="website-analytics" heading="6. Website analytics and tracking">
        ...
        <p>
          <strong>Your choice.</strong> When you first visit, you can choose to
          allow all of these tools or only the essential ones.{' '}
          <strong>Google Analytics</strong> and <strong>Microsoft Clarity</strong>{' '}
          load only if you accept. <strong>Funnel Agent</strong> and{' '}
          <strong>Vercel Analytics</strong> run to operate and measure the site
          regardless of that choice. You can change your selection at any time
          using the &ldquo;Cookie preferences&rdquo; link in the footer, and you
          can block cookies through your browser settings. Your choice does not
